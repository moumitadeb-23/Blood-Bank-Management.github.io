...
3. Download project from github (https://github.com/moumitadeb-23/Blood-Bank-Management.github.io.git).

   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        ii>git clone https://github.com/moumitadeb-23/Blood-Bank-Management.github.io.git
